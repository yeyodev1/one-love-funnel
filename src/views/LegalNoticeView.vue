  ...
  <div class="legal-notice">
    <div class="legal-notice__container">
      <header class="legal-notice__header">
        <h1 class="legal-notice__title">
          Aviso Legal - Términos de Uso del Sitio y Condiciones de Contratación
        </h1>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          ...
          dicho acceso y/o uso, los presentes términos de uso, no obstante, por el mero uso de la
          página web no significa el inicio de relación laboral/comercial alguna.
        </p>

        <h3 class="legal-notice__subsection-title">
        ...
        <p>
          El USUARIO se compromete a hacer un uso adecuado de los contenidos que ofrece a través de
          su web y con carácter enunciativo pero no limitativo, a no emplearlos para:
        </p>
        <ul>
          <li>
            (a) incurrir en actividades ilícitas, ilegales o contrarias a la buena fe y al orden
            público;
          </li>
          <li>
            (b) difundir contenidos o propaganda de carácter racista, xenófobo, pornográfico-ilegal,
            de apología del terrorismo o atentatorio contra los derechos humanos;
          </li>
          <li>
            (c) provocar daños en los sistemas físicos y lógicos de la web, de sus proveedores o de
            terceras personas, introducir o difundir en la red virus informáticos o cualesquiera
            otros sistemas físicos o lógicos que sean susceptibles de provocar los daños
            anteriormente mencionados;
          </li>
          <li>
            (d) intentar acceder y, en su caso, utilizar las cuentas de correo electrónico de otros
        ...
        <ul>
          <li>
            Formulario de contacto, donde el USUARIO deberá rellenar el campo de correo electrónico,
            asunto y nombre.
          </li>
          <li>
            Formulario de suscripción, rellenando el USUARIO los campos necesarios para la
            suscripción a la web con los campos de nombre, y email
          </li>
          <li>
            Formulario de venta, rellenando el USUARIO los campos necesarios para la venta con los
            campos de nombre, email, dirección y DNI.
          </li>
        </ul>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          Queda terminantemente prohibido compartir la licencia para uso con más personas, cada
          licencia es personal e intransferible reservándonos cuantas acciones civiles y penales nos
          asistan en aras de salvaguardar nuestros derechos, todo ello bajo apercibimiento de
          incurrir en un delito contra la propiedad intelectual.
        </p>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          Usted comprende y acepta que el valor que obtendrá del Programa será en proporción al
          nivel de esfuerzo que realice; su nivel de comprensión; su experiencia, habilidades, nivel
          de deseo y disposición para tomar acciones con respecto a la información proporcionada; y
          factores externos como eventos mundiales, condiciones del mercado, empleo, relaciones y
          otras incógnitas.
        </p>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          Visa/Mastercard/American Express; el usuario deberá proporcionar el nombre del titular de
          la tarjeta, el número, la fecha de caducidad y el CVV.
        </p>
      ...
      <section class="legal-notice__section">
        ...
        <ol>
          ...
          <li>
            ...
            ambas partes se comprometen a intentar alcanzar un acuerdo de forma dialogada y
            satisfactoria para ambas partes antes de acudir a realizar una reclamación formal.
          </li>
        </ol>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          El USUARIO puede cancelar su suscripción o cualquier servicio SaaS en cualquier momento,
          sin penalidades, conforme a la normativa aplicable en Ecuador, incluyendo la Ley Orgánica
        ...
        <ul>
          ...
          <li>
            Alternativamente, enviar un correo al contacto indicado en este documento con el asunto
            “Cancelación de Servicio”.
          </li>
        </ul>
        <h3 class="legal-notice__subsection-title">Plazos de efectividad</h3>
        <p>
          La cancelación es efectiva de manera inmediata desde la solicitud. En planes con
          renovación automática, el USUARIO puede optar por que surta efecto al finalizar el ciclo
          de facturación vigente para mantener acceso hasta esa fecha.
        </p>
        ...
        <ul>
          ...
          <li>
            Podrán otorgarse créditos proporcionales por el tiempo no utilizado desde la fecha de
            solicitud, cuando el plan lo permita y no existan servicios personalizados ya
            entregados.
          </li>
          <li>
            El procesamiento de reembolsos o créditos se realiza en un plazo máximo de 10 días
            hábiles, sujeto a los tiempos de la pasarela de pago.
          </li>
        </ul>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          Las devoluciones aplican a servicios digitales conforme a la normativa ecuatoriana. Todas
          las solicitudes se evaluarán de forma objetiva y transparente.
        </p>
        <h3 class="legal-notice__subsection-title">Condiciones de aplicación</h3>
        <ul>
          <li>Errores de facturación o cobros no autorizados.</li>
          <li>
            Indisponibilidad prolongada del servicio atribuible al proveedor, no derivada de fuerza
            mayor.
          </li>
          <li>
        ...
        <ul>
          <li>
            Enviar la solicitud al correo de contacto indicado en este documento con el asunto
            “Solicitud de Reembolso”.
          </li>
          <li>
            Incluir: nombre completo, correo registrado, referencia de pago, fecha del cargo y
            descripción del motivo.
          </li>
          <li>
            Adjuntar comprobantes (factura, evidencia del cargo o evidencia técnica del incidente,
            si aplica).
          </li>
        </ul>
        <h3 class="legal-notice__subsection-title">Plazos de procesamiento</h3>
        <p>
          La evaluación y notificación de la resolución se realizará en un plazo máximo de 10 días
          hábiles. De proceder, el reembolso se cursará por el mismo método de pago utilizado,
          sujeto a los tiempos de la pasarela.
        </p>
      ...
      <section class="legal-notice__section">
        ...
        <p>
          El servicio es exclusivamente digital; no incluye garantías físicas ni bienes tangibles.
          Se provee con soporte razonable, actualizaciones y mejoras continuas, sin garantía de
          resultados específicos, los cuales dependen de factores externos y del uso del USUARIO.
        </p>
      </section>
      ...
      <section class="legal-notice__section">
        ...
        <ul>
          <li>
            <strong>Del proveedor:</strong> Proveer acceso al servicio, mantener medidas de
            seguridad acordes a la técnica, ofrecer soporte razonable y cumplir la normativa
            aplicable.
          </li>
          <li>
            <strong>Del USUARIO:</strong> Usar el servicio de forma lícita, mantener datos de pago
            actualizados, respetar los términos de uso, no vulnerar derechos de terceros y proteger
            sus credenciales.
          </li>
          <li>
            En caso de controversias, las partes procurarán una resolución amistosa y, de ser
            necesario, se someterán a la normativa ecuatoriana aplicable.
          </li>
        </ul>
      </section>
    </div>
